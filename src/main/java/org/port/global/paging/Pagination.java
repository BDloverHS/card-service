...
public class Pagination {
    ...
    public Pagination(int page, int total, int ranges, int limit, HttpServletRequest request) {
        ...
        baseUrl = request == null ? "?" : String.format("%s://%s:%s%s/?", request.getScheme(), request.getServerName(), request.getServerPort(), StringUtils.hasText(request.getContextPath()) ? request.getContextPath() : "/");
